    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {request.method === 'editor' ? (
        <textarea
          ...
          placeholder={request.placeholder || t('permission.input.editorPlaceholder')}
          rows={7}
          autoFocus
        ...
        <input
          ...
          value={inputValue}
          onChange={(e) => setInputValue(e.target.value)}
          placeholder={request.placeholder || t('permission.input.placeholder')}
          autoFocus
